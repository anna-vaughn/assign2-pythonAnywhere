...
def get_file(request):
    ...
    response = HttpResponse(
        ...
        headers={'Content-Disposition': 'attachment; filename="customer_data.csv"'},
    )

    writer = csv.writer(response)
    writer.writerow(['Name', 'Organization', 'Role', 'Email', 'Phone', 'Bldg-Room', 'Address',
                     'City', 'State', 'Zip Code'])
    for customer in customers:
        writer.writerow([customer.cust_name, customer.organization, customer.role, customer.email, customer.phone,
                        customer.bldgroom, customer.address, customer.city, customer.state,
                        customer.zipcode])
